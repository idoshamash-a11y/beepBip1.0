...
class AppTheme {
  ...
  // Light Theme Colors (Ignored mostly for this dark UI)
  ...
  // Dark Theme Colors
  static const Color darkBackground = Color(0xFF050505); // Vantablack Base
  static const Color darkSurface = Color(0xFF0F0F11); // Deep inner core
